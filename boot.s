...
;---------------------------------------- MB test ----------
	...
	mov r3,#0x28000			;up to 128+32kbyte
	add r3,r3,#0x240		;+headers (Adv(48)*2)
	mov r1,r0
_loop
...
giveup	bhi giveup
	...
	ldr r4,=textstart	;textstart=ptr to EMU rom info
	str r6,[r4]
